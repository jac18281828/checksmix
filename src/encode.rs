...
mod tests {
    ...
    // These tests pin encoded bytes against the MMIX opcode table: the
    // opcode, then X, Y, Z — e.g. TRAP 1,2,3 → #00 01 02 03. The data
    // directives pin the width each one emits instead.
