...
TestNum	IS	$0	% Current test number
Temp	IS	$1	% Temporary register
Expect	IS	$2	% Expected value
Result	IS	$3	% Actual result
...
% ========================================
Test1	SET	Result,#0123456789ABCDEF
...
% ========================================
Test20  SET     $20,#100        % Address
        SET     $21,#42         % Value to store
        STB     $21,$20,$255    % Store byte
        LDB     Result,$20,$255 % Load it back
        SET     Expect,#42
        CMP     Temp,Result,Expect
        PBZ     Temp,Test21
        JMP     TestFail
...
% ========================================
Test21  SET     $20,#200        % Address
        SET     $21,#ABCD       % Value to store
        STW     $21,$20,$255    % Store wyde
        LDWU    Result,$20,$255 % Load it back (unsigned)
        SET     Expect,#ABCD
        CMP     Temp,Result,Expect
        PBZ     Temp,Test22
        JMP     TestFail
...
% ========================================
Test22  SET     $20,#300        % Address
        SET     $21,#12345678   % Value to store
        STT     $21,$20,$255    % Store tetra
        LDT     Result,$20,$255 % Load it back
        SET     Expect,#12345678
        CMP     Temp,Result,Expect
        PBZ     Temp,Test23
        JMP     TestFail
...
% ========================================
Test23  SET     $20,#400        % Address (8-byte aligned)
        SET     $21,#123456789ABCDEF
        STO     $21,$20,$255    % Store octa
        LDO     Result,$20,$255 % Load it back
...
% ========================================
Test25  SET     $10,#0101010101010101
        SADD    Result,$10,$255
...
% ========================================
Test30  SET     $10,#FFFFFFFFFFFFFFFF
        SET     $11,1
        ADDU    Result,$10,$11
...
% ========================================
Test31  SET     $10,#FFFFFFFFFFFFFF00
        ADDUI   Result,$10,#FF
...
TestFail	SET	$0,FailMsg
	...
	SET	$255,TestNum	% Show which test failed
