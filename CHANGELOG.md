...
* The header sentence labeled `#`-prefixed hex "octal". Hex and octal are now named separately, and the header notes that `0`-prefixed octal is a checksmix extension — Knuth reads a leading `0` as decimal
